...
CREATE TABLE `failedorder` (
  ...
  `numeC` varchar(45) NOT NULL,
  `numeP` varchar(45) NOT NULL,
  PRIMARY KEY (`nrOrder`,`numeC`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `failedorder` WRITE;
/*!40000 ALTER TABLE `failedorder` DISABLE KEYS */;
/*!40000 ALTER TABLE `failedorder` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `orders` (
  `nrOrder` int(11) NOT NULL AUTO_INCREMENT,
  `numeC` varchar(45) NOT NULL,
  `numeP` varchar(45) NOT NULL,
...
-- Dump completed on 2020-04-16 22:53:47
